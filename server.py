...
mock_tooluse = [
    {
        ...
        "name": "retrieve",  # 检索工具
        "params": {
            "knowledge_base": "physics_textbook",  # 知识库名称
            "keyword": "定态薛定谔方程 量子谐振子"  # 检索关键词
        },
    ...
    },
    {
        ...
        "count": 10,  # 返回文档数量
        "documents": [{
            "snippet": "定态薛定谔方程为...",  # 文档片段
            "url": "http://example.com"  # 文档链接
            } for _ in range(10)]
    }
]
...
class MessagePayload(BaseModel):
    parentId: str | None = None  # 父消息ID，用于对话上下文, None 或无匹配的parentId时创建新对话
    content: str  # 消息内容
...
async def get_history(page: int = 1):
    ...
    } for history in mock_history[start:end]]
